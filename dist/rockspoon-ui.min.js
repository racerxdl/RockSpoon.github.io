...
rockspoonUi.directive("rsAddress", function() {
  return {
    ...
    template:
      ...
      "    <tr>" +
      "      <td colspan='3'>" +
      "        <rs-text-edit mandatory='mandatory' class='address' ng-model='ngModel.address1' label='Address Line 1' label-same-line='false' placeholder='e.g: Street address, P.O Box'></rs-text-edit>" +
      "      </td>" +
      "    </tr>" +
      "    <tr>" +
      "      <td colspan='3'>" +
...
rockspoonUi.directive("rsCreateAccount", function() {
  return {
    ...
    "  <rs-text-edit-compare mandatory='true' label-same-line='false' ng-show='showPassword' compare-model='ngModel.confirmPassword' ng-model='ngModel.password' label='Password'></rs-text-edit-compare>" +
    "  <rs-text-edit-compare mandatory='true' label-same-line='false' ng-show='showPassword' compare-model='ngModel.confirmShortPassword' ng-model='ngModel.shortPassword' label='Short Password'></rs-text-edit-compare>" +
