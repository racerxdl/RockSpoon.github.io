...
rockspoonUi.directive('compareTo', function() {
  ...
  return {
    ...
    "    <tr>" +
    "      <td>" +
    "        <rs-text-edit-compare mandatory='true' placeholder='{{placeholder}}' required label='{{label}}' label-same-line='false' ng-model='ngModel.password' compare-model='ngModel.confirmPassword'></rs-text-edit-compare>" +
    "      </td>" +
    "    </tr>" +
    "    <tr>" +
    "      <td>" +
...
rockspoonUi.directive("rsCreateAccount", function() {
  return {
    ...
    "  <rs-text-edit mandatory='true' label-same-line='false' ng-model='ngModel.SSN' label='Social Security Number'></rs-text-edit>" +
    "  <rs-text-edit-compare input-type='text' mandatory='true' label-same-line='false' ng-model='ngModel.email' compare-model='ngModel.confirmEmail' label='Email'></rs-text-edit-compare>" +
    "  <rs-text-edit-compare input-type='{{inputType}}' mandatory='true' label-same-line='false' compare-model='ngModel.confirmPassword' ng-model='ngModel.password' label='Password'></rs-text-edit-compare>" +
    "  <rs-text-edit-compare input-type='{{inputType}}' mandatory='true' label-same-line='false' compare-model='ngModel.confirmShortPassword'  ng-model='ngModel.shortPassword' label='Short Password'></rs-text-edit-compare>" +
...
rockspoonUi.directive("rsNavbar", function() {
  ...
  return {
    ...
    "{{ngModel.firstName}} {{ngModel.lastName}}" +
    "<b class='caret'></b>" +
    "</a>" +
    ...
    link: function(scope, elm, attrs) {
      ...
      if (scope.labelSameLine !== undefined && scope.labelSameLine !== true)
        d = angular.element(
          ...
          "<div style='display:table-row'>" +
          "  <div class='text-field' style='width:100%;display:table-cell'>" +
          "    <input name='input_{{::uid}}' type='{{inputType}}' placeholder='{{::placeholder}}' ng-model='ngModel' ng-model-options='{allowInvalid: true}' ng-change='onChange()' " + currency + digit + decimal + required + "/>" +
          ...
          "<div style='display:table-row'>" +
          "  <div class='text-field' style='width:100%;display:table-cell'>" +
          "    <input name='input_compare_{{::uid}}' type='{{inputType}}' placeholder='{{::placeholder}}' ng-model='compareModel' ng-model-options='{allowInvalid: true}' compare-to='ngModel' ng-change='onChange()' " + currency + digit + decimal + required + "/>" +
        ...
        "</div>" +
        "<div class='text-field' style='width:100%;display:table-cell'>" +
        "  <input name='input_compare{{::uid}}' type='{{inputType}}' placeholder='{{::placeholder}}' ng-model='compareModel'  ng-model-options='{allowInvalid: true}'compare-to='ngModel' ng-change='onChange()' " + currency + digit + decimal + required + "/>" +
