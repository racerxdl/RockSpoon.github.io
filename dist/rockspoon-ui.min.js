...
rockspoonUi.directive("rsAddress", function() {
  return {
    ...
    template:
      ...
      "    <tr>" +
      "      <td colspan='3'>" +
      "        <rs-text-edit mandatory='mandatory' class='address' ng-model='ngModel.address' label='Address Line 1' label-same-line='false' placeholder='e.g: Street address, P.O Box, Apartment, Suit, Unit, Floor'></rs-text-edit>" +
      "      </td>" +
      "    </tr>" +
      "    <tr>" +
      "      <td style='width:37%'>" +
