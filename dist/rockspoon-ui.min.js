var rockspoonUi = angular.module("rockspoon-ui", ["ui.bootstrap", "sly", "ngAnimate", "ui.sortable", "ps.inputTime"]);
...
rockspoonUi.directive("rsALaCarteMenu", function() {
  ...
  return {
    ...
    template:
      "<div align='' class='rs-a-la-carte-menu-control'>" +
      "  <div class='rs-menu-title'>{{ngModel.name}}</div>" +
      "  <div class='rs-menu-description'><b>Description:</b> {{ngModel.description}}</div>" +
      "  <rs-a-la-carte-menu-items ng-model='ngModel.items'></rs-a-la-carte-menu-items>" +
      "</div>"
  };
  ...
  return {
    link: function($scope, elm) {
      var obj = $compile(
        ...
        "  <div class='rs-menu-title'>{{ngModel.name}}</div>" +
        "  <div align='' class='rs-menu-description'><b>Description: </b>{{ngModel.description}}</div>" +
        "</div>")($scope);
...
rockspoonUi.directive("rsAddress", function() {
  return {
    ...
    template:
      ...
      "    <tr>" +
      "      <td colspan='1'>" +
      "        <rs-country ng-model='ngModel.country' label-same-line='false'></rs-country>" +
      "      </td>" +
      "    </tr>" +
      "    <tr>" +
      "      <td colspan='3'>" +
      "        <rs-text-edit class='address' ng-model='ngModel.address1' label='Address Line 1' label-same-line='false' placeholder='e.g: Street address, P.O Box'></rs-text-edit>" +
      "      </td>" +
      "    </tr>" +
      "    <tr>" +
      "      <td colspan='3'>" +
      "        <rs-text-edit class='address' ng-model='ngModel.address2' label='Address Line 2' label-same-line='false' placeholder='e.g: Apartment, Suit, Unit, Floor'></rs-text-edit>" +
      "      </td>" +
      "    </tr>" +
      "    <tr>" +
      "      <td style='width:37%'>" +
      "        <rs-text-edit class='city' ng-model='ngModel.city' label='City' label-same-line='false'></rs-text-edit>" +
      "      </td>" +
      "      <td class='column-space' style='width:37%'>" +
      "        <rs-state country='ngModel.country' ng-model='ngModel.state' label-same-line='false'></rs-state>" +
      "      </td>" +
      "      <td class='column-space'>" +
      "        <rs-text-edit label='Zip Code' label-same-line='false' ng-model='ngModel.zipCode' placeholder='Enter Number'></rs-text-edit>" +
      "      </td>" +
      "    </tr>" +
      "  </table>" +
      "</div>"
...
rockspoonUi.directive("rsBrandInfo", function() {
  return {
    ...
    template: "<div class='rs-brand-info'><rs-text-edit label='Name' label-same-line='false' placeholder='Supplier Name' ng-model='ngModel.name'></rs-text-edit><table><tr><td><rs-label>Logo</rs-label></td><td><div class='description'><rs-label>Description</rs-label></div></td></tr><tr><td><rs-image-picker-generic ngModel='ngModel.logo'><rs-image-picker ng-model='ngModel.logo' type=\"image\"></rs-image-picker></rs-image-picker-generic></td><td class='description-column'><div><textarea ng-model='ngModel.description'></textarea></div></td></tr></table></div>"
  };
});
...
rockspoonUi.directive("rsBusinessEntity", function() {
  return  {
    ...
    template:
    "<div class='rs-business-entity'>" +
    "  <rs-text-edit label='Business Entity Name' ng-model='ngModel.name' label-same-line='false'></rs-text-edit>" +
    "  <rs-text-edit label='Doing Business as' ng-model='ngModel.business' label-same-line='false'></rs-text-edit>" +
    "  <rs-country label='Country' ng-model='ngModel.country' label-same-line='false'></rs-country>" +
    "  <rs-combo-box label='Type of business entity' options='businessEntityOptions' label-same-line='false' ng-model='ngModel.businessType'></rs-combo-box>" +
    "  <rs-text-edit class='rs-tax-id' label='Tax ID' placeholde='Enter Tax Id' ng-model='ngModel.taxId' label-same-line='false'></rs-text-edit>" +
    ...
    "    </div>" +
    "  </div>" +
    "  <rs-address ng-model='ngModel.address'></rs-address>" +
...
/*global rockspoonUi: true */
rockspoonUi.directive("rsChoosePassword", function() {
  return {
    controller: ["$scope", "$element", "UID", function($scope, $element, UID) {
      $scope.uid = UID.create();
  ...
  return {
    link: function(scope, elm, attrs, ctrl) {
      ...
      if (scope.labelSameLine !== undefined && scope.labelSameLine !== true)
        d = $compile("<div style='display:table-row'><div class='combo-label' style='display:table-cell'><label class='" + paddingClass + "' style='text-align:right'>{{::label}}</label></div></div><div style='display:table-row'><div class='combo-field-empty' style='width:100%;display:table-cell'><div class='arrow'></div><select ng-model='ngModel'></select></div>")(scope);
      else
        d = $compile("<div class='combo-label' style='display:table-cell'><label class='" + paddingClass + "' style='text-align:right'>{{::label}}</label></div><div class='combo-field-empty' style='width:100%;display:table-cell'><div class='arrow'></div><select></select></div>")(scope);
    ...
    transclude: true,
    terminal: true,
    template: "<div class='rs-combo-box'></div>"
  };
}]);
...
rockspoonUi.directive("rsCountry", [function() {
  return {
    ...
    template:
      ...
      "  <rs-combo-box label='Country' options='options' label-same-line='labelSameLine' ng-model='ngModel' on-change='onChange'></rs-combo-box>" +
      "</div>"
  };
  ...
  return {
    ...
    template:
      "<div class='rs-state'>" +
      "  <rs-combo-box label='State' options='options' label-same-line='labelSameLine' ng-model='ngModel' on-change='onChange'></rs-combo-box>" +
      "</div>"
  };
}]);
...
rockspoonUi.directive("rsCreateAccount", function() {
  return {
    ...
    template:
      "<div class='rs-create-account'>" +
      "  <rs-text-edit label-same-line='false' ng-model='ngModel.firstName' label='First Name'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-model='ngModel.lastName' label='Last Name'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-model='ngModel.email' label='Email'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-model='ngModel.confirmEmail' label='Confirm Email'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-show='!showPassword' password ng-model='ngModel.password' label='Password'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-show='!showPassword' password ng-model='ngModel.confirmPassword' label='Confirm Password'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-show='showPassword' ng-model='ngModel.password' label='Password'></rs-text-edit>" +
      "  <rs-text-edit label-same-line='false' ng-show='showPassword' ng-model='ngModel.confirmPassword' label='Confirm Password'></rs-text-edit>" +
      "  <rs-check-box id='showPassword' ng-model='showPassword' label='Show Password'></rs-check-box>" +
...
rockspoonUi.filter("formattedRSDateTime", function() {
  ...
  return function(input) {
    ...
    return moment(input).format("MMMM Do");
  };
  ...
  return {
    ...
    customClickHandler: function(event) {
      ...
      $timeout(function() {
        ...
        var availableTop = element.position().top;
        var availableBottom = scope.scrollableElement.height() - element.height() - availableTop;
        var padding = 20;
  ...
  return {
    controller: ["$scope", "$element", "dropDownToggleService", function($scope, $element, dropDownToggleService) {
      ...
      var handleDropDown = function() {
        var availableTop = $element.position().top;
        var availableBottom = scrollableElement.height() - $element.height() - availableTop;
        var padding = 20;
    ...
    template:
      ...
      "    <input class='dropdown-toggle' dropdown-toggle type='text' placeholder='Date'  value='{{ngModel | formattedRSDate}}' readonly>" +
...
rockspoonUi.directive("rsIntlPhoneNumber", function() {
  ...
  return {
    ...
    template:
      ...
      "    <rs-combo-box ng-model='ngModel.type' options='phoneType'></rs-combo-box>" +
      "  </div>" +
      "  <div class='rs-phone-field'>" +
...
/*global rockspoonUi: true */
rockspoonUi.directive("rsSearchableMultiSelectList", function() {
  return {
    restrict: "E",
    scope: {
      ngModel: "=",
    ...
    controller: ["$scope", function($scope) {
      ...
      $scope.onSelect = function(index) {
        ...
        selectedItems.push($scope.searchResults[index]);
    ...
    template:
      "<div class='rs-list-container'>" +
      "  <div class='top-bar'>Menu Items (Food)</div>" +
      "  <div class='search-box'>" +
      "    <i class='glyphicon glyphicon-search'></i>" +
      "    <input class='inputbox' type='text' ng-model='searchValue' ng-change='onSearch(searchValue)'>" +
      "  </div>" +
      "  <div class='search-results'>" +
      "    <div class='result' ng-class='{clicked: result.selected}' ng-repeat='result in searchResults' ng-click='onSelect($index)'>" +
      "      <div class='photo'><img ng-src='{{result.url}}' alt='Image' /></div>" +
...
rockspoonUi.directive("rsHttpPrefix", function() {
  ...
  return {
    ...
    template: "<div class='rs-social-text-edit' ng-class='{lightgray:ngModel.$isNew}'><div class='social-type' style='display:table-cell'><rs-combo-box ng-model='ngModel.type' options='socialType'></rs-combo-box></div><div class='social-field' style='display:table-cell'><input type='text' rs-http-prefix placeholder='Add URL' ng-model='ngModel.url' ng-change='changed()'></div></div>"
  };
...
rockspoonUi.directive("currency", function() {
  ...
  return {
    link: function(scope, elm, attrs) {
      ...
      if (scope.labelSameLine !== undefined && scope.labelSameLine !== true)
        d = $compile("<div style='display:table-row'><div class='text-label' style='display:table-cell'><label class='" + paddingClass + "' style='text-align:right'>{{::label}}<i class='glyphicon glyphicon-asterisk' ng-if='mandatory === true'></i></label></div></div><div style='display:table-row'><div class='text-field' style='width:100%;display:table-cell'><input type='" + type + "' placeholder='{{::placeholder}}' ng-model='ngModel' ng-change='onChange()' " + currency + digit + decimal +"/></div></div>")(scope);
      else
        d = $compile("<div class='text-label' style='display:table-cell'><label class='" + paddingClass + "' style='text-align:right'>{{::label}}<i class='glyphicon glyphicon-asterisk' ng-if='mandatory === true'></i></label></div><div class='text-field' style='width:100%;display:table-cell'><input type='" + type + "' placeholder='{{::placeholder}}' ng-model='ngModel' ng-change='onChange()' " + currency + digit + decimal + "/></div>")(scope);
    ...
    template: "<div class='rs-text-edit'></div>"
  };
  ...
  return {
    ...
    "  </div>" +
    "  <div>" +
    "    <textarea ng-model='ngModel' ng-change='changed()' placeholder='{{::placeholder}}'></textarea>" +
    "  </div>" +
    "</div>"
  };
});
...
rockspoonUi.directive("rsTitleDescription", function() {
  return {
    ...
    template:
      "<div class='rs-title-description'>" +
      "  <rs-text-edit label='{{type}} Name' placeholder='{{type}} Name' label-same-line='false' mandatory='true' ng-model='ngModel.title'></rs-text-edit>" +
      "  <rs-text-edit label='Abbreviation' placeholder='Abbreviation' label-same-line='false' mandatory='true' ng-model='ngModel.abbreviation' ng-if='showAbbreviation'></rs-text-edit>" +
      "  <rs-text-area label='{{type}} Description' placeholder='{{type}} Description' mandatory='false' ng-model='ngModel.description'></rs-text-area>" +
      "</div>"
  };
});
/*global rockspoonUi: true */
